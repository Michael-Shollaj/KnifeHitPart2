...
public class MushroomRotation : MonoBehaviour
{
    ...
    //a custom class representing a single rotation "element" of the mushroom's rotation pattern
...
#pragma warning restore 0649
    ...
    //this will be set to the Wheel Joint 2D from the MushroomMotor object
